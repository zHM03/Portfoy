...
Mein größtes Ziel ist es, nachhaltige und benutzerfreundliche Projekte zu entwickeln, die in der Softwarewelt einen bleibenden Eindruck hinterlassen. Wenn du auch Interesse an Technologie hast oder gemeinsam an einem Projekt arbeiten möchtest, freue ich mich auf deine Nachricht!`,
  ...
  ar: {
    ...
    contact: "اتصال",
    about_title: "عني",
    about_paragraph: `مرحبًا! أنا هشام، مطور برمجيات شغوف. بدأت اهتمامي بالبرمجة من خلال بعض الأتمتة الصغيرة، ثم تطور لاحقًا ليصبح شغفًا مهنيًا. اليوم، أطور واجهات ويب تركز على المستخدم، وأقوم بإنشاء تطبيقات سطح مكتب وحلول بوت باستخدام لغة Python.

أقوم بإنشاء مواقع ويب حديثة وسريعة الاستجابة باستخدام HTML وCSS وJavaScript، وأطور تطبيقات قائمة على قواعد البيانات باستخدام Python. من خلال إنشاء بوتات تسهل إدارة المجتمعات، اكتشفت أن البرمجة يمكن أن تساهم ليس فقط على المستوى الفردي بل الاجتماعي أيضًا.
